...
#include "tf2/utils.h"  // Contains function to provide Quaternion --> Euler
...
// Function to calculate difference between two angles (radians)
    ...
    , is_first_odom_(true)
{
    ...
    // Declare parameters for this node for configuration
    ...
    {
        std::cout << "Error: Invalid no. of samples!" << std::endl;
        return;
    }
...
{
    // Need to convert Quaternion to Euler Angles.
    // Quaternion
    ...
    // Postion and Orientation Increment
    ...
    // Create Guassian Distributions
    // std::normal_distribution<type>(mean, variance)
