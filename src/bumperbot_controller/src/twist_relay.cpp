...
public:
    TwistRelay()
        : Node("twist_relay")
    {
        controller_sub_ = create_subscription<geometry_msgs::msg::Twist>("/bumperbot_controller/cmd_vel_unstamped", 10,
                                                                                std::bind(&TwistRelay::controller_twist_callback, this, _1));
        controller_pub_ = create_publisher<geometry_msgs::msg::TwistStamped>("/bumperbot_controller/cmd_vel", 10);

        joy_sub_ = create_subscription<geometry_msgs::msg::TwistStamped>("/input_joy/cmd_vel_stamped", 10,
                                                                            std::bind(&TwistRelay::joy_twist_callback, this, _1));
...
private:
    ...
    void joy_twist_callback(const geometry_msgs::msg::TwistStamped::SharedPtr msg)
    {
        ...
        twist_msg_ = msg->twist;
        joy_pub_->publish(twist_msg_);
    }
